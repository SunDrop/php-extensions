...
#define PHP_GPEUNIT_VERSION "0.1.0" /* Replace with version number for your extension */
...
ZEND_BEGIN_MODULE_GLOBALS(gpeunit)
	long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(gpeunit)
*/

/* In every utility function you add that needs to use variables 
   in php_gpeunit_globals, call TSRMLS_FETCH(); after declaring other 
   variables used by that function, or better yet, pass in TSRMLS_CC
   after the last function argument and declare your utility function
   with TSRMLS_DC after the last declared argument.  Always refer to
   the globals in your function as GPEUNIT_G(variable).  You are 
